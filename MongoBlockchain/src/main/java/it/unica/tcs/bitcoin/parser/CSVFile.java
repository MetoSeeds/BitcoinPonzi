...
import it.unica.tcs.bitcoin.parser.Model.Triple;
...
public class CSVFile {
    ...
    private static final String CSVAddressesPath = "CSV//Addresses//";
 ...
 */
    ...
    * @return ArrayList<String> of addresses
     */
    ArrayList<String> getPonziAddresses() {
        ArrayList<String> addresses = new ArrayList<>();
        try {
            String line;
            fileReader = new BufferedReader(new FileReader(CSVAddressesPath + "PonziAddresses.csv"));
            String prev = "link";
            fileReader.readLine();
    ...
    */
    ...
    public HashMap<String, Long> readNotPonziAddressesWithNumberTransaction() {
        HashMap<String, Long> addressWithNumberTransactions = new HashMap<>();

        try {
            String line;
            fileReader = new BufferedReader(new FileReader(CSVAddressesPath + "NotPonziAddressesWithNumberTransaction.csv"));
            fileReader.readLine();
            while ((line = fileReader.readLine()) != null) {
                // use comma as separator
                String[] cols = line.split(COMMA_DEL);
    ...
    ArrayList<Triple<String, ArrayList<String>, String>> getDonationAddresses() {
        ...
        try {
            String line;
            fileReader = new BufferedReader(new FileReader("C://Users//serus//IdeaProjects//MongoBlockchain//CSV//Address//AddressDonation.csv"));
            String prev = "link";
            fileReader.readLine();
            while ((line = fileReader.readLine()) != null) {
                // use comma as separator
    ...
    ArrayList<String> getRansomwareAddresses() {
        ...
        try {
            String line;
            fileReader = new BufferedReader(new FileReader("C://Users//serus//IdeaProjects//MongoBlockchain//CSV//Address//ransomware.csv"));
            fileReader.readLine();
            while ((line = fileReader.readLine()) != null) {
                // use comma as separator
                String[] cols = line.split(COMMA_DEL);
